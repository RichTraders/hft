...
namespace core {
trading::ExecutionReport* WsOeDomainMapper::to_execution_report(
...
trading::OrderCancelReject* WsOeDomainMapper::to_cancel_reject(
...
trading::OrderMassCancelReport* WsOeDomainMapper::to_mass_cancel_report(
...
trading::OrderReject WsOeDomainMapper::to_reject(const WireReject& msg) const {
...
trading::ExecutionReport* WsOeDomainMapper::allocate_execution_report() const {
  return response_manager_->execution_report_allocate();
}

trading::OrderCancelReject* WsOeDomainMapper::allocate_cancel_reject() const {
  return response_manager_->order_cancel_reject_allocate();
}

trading::OrderMassCancelReport* WsOeDomainMapper::allocate_mass_cancel_report()
    const {
