...
#ifndef BINANCE_FUTURES_MD_CONNECTION_HANDLER_H
#define BINANCE_FUTURES_MD_CONNECTION_HANDLER_H

#include "websocket/connection_handler.h"

struct BinanceFuturesMdConnectionHandler {
...
#endif  // BINANCE_FUTURES_MD_CONNECTION_HANDLER_H
