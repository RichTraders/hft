...
class FixOeCore {
 public:
  ...
  using WireExecutionReport = FIX8::NewOroFix44OE::ExecutionReport*;
  using WireCancelReject = FIX8::NewOroFix44OE::OrderCancelReject*;
  using WireMassCancelReport = FIX8::NewOroFix44OE::OrderMassCancelReport*;
  using WireReject = FIX8::NewOroFix44OE::Reject*;
