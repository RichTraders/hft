...
#ifndef BINANCE_SPOT_OE_DISPATCHER_TPP
#define BINANCE_SPOT_OE_DISPATCHER_TPP

template <typename ExchangeTraits>
void BinanceSpotOeDispatchRouter::process_message(
      ...
      [&context, &message](auto&& arg) {
        ...
        if constexpr (std::is_same_v<T,
          ...
          handle_execution_report<ExchangeTraits>(arg, context, message);
            ...
            std::is_same_v<T, typename ExchangeTraits::SessionLogonResponse>) {
          ...
          if constexpr (ExchangeTraits::supports_cancel_and_reorder()) {
            handle_cancel_and_reorder_response<ExchangeTraits>(arg,
                ...
                message);
                                 ...
                                 typename ExchangeTraits::ModifyOrderResponse>) {
          ...
          handle_cancel_all_response<ExchangeTraits>(arg, context, message);
                                 ...
                                 typename ExchangeTraits::PlaceOrderResponse>) {
          ...
          handle_api_response<ExchangeTraits>(arg, context, message);
            ...
            std::is_same_v<T, typename ExchangeTraits::BalanceUpdateEnvelope>) {
...
template <typename ExchangeTraits>
void BinanceSpotOeDispatchRouter::handle_execution_report(
  ...
  std::string_view dispatch_type = "8";
...
template <typename ExchangeTraits>
void BinanceSpotOeDispatchRouter::handle_session_logon(
...
template <typename ExchangeTraits>
void BinanceSpotOeDispatchRouter::handle_user_subscription(
...
template <typename ExchangeTraits>
void BinanceSpotOeDispatchRouter::handle_api_response(
...
template <typename ExchangeTraits>
void BinanceSpotOeDispatchRouter::handle_cancel_and_reorder_response(
...
template <typename ExchangeTraits>
void BinanceSpotOeDispatchRouter::handle_cancel_all_response(
...
template <typename ExchangeTraits>
void BinanceSpotOeDispatchRouter::handle_place_order_response(
...
template <typename ExchangeTraits>
void BinanceSpotOeDispatchRouter::handle_modify_order_response(
    const typename ExchangeTraits::ModifyOrderResponse& response,
    const core::WsOeDispatchContext<ExchangeTraits>& context,
    const typename ExchangeTraits::WireMessage& /*message*/) {

  if constexpr (std::is_same_v<typename ExchangeTraits::ModifyOrderResponse,
                    std::monostate>) {
    (void)response;
    (void)context;
    return;
...
template <typename ExchangeTraits>
void BinanceSpotOeDispatchRouter::handle_balance_update(
...
template <typename ExchangeTraits>
void BinanceSpotOeDispatchRouter::handle_account_updated(
...
#endif  //BINANCE_SPOT_OE_DISPATCHER_TPP
