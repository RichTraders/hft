...
MarketOrderBook<Strategy, OeTraits>::MarketOrderBook(const TickerId& ticker_id,
...
template <typename Strategy, typename OeTraits>
MarketOrderBook<Strategy, OeTraits>::~MarketOrderBook() {
...
template <typename Strategy, typename OeTraits>
void MarketOrderBook<Strategy, OeTraits>::update_bid(int idx, Qty qty) {
...
template <typename Strategy, typename OeTraits>
void MarketOrderBook<Strategy, OeTraits>::update_ask(const int idx, const Qty qty) {
...
template <typename Strategy, typename OeTraits>
Qty MarketOrderBook<Strategy, OeTraits>::best_bid_qty() const noexcept {
  const int idx = best_bid_idx();
  if (idx < 0)
...
template <typename Strategy, typename OeTraits>
Qty MarketOrderBook<Strategy, OeTraits>::best_ask_qty() const noexcept {
  const int idx = best_ask_idx();
  if (idx < 0)
    return Qty{common::kQtyInvalid};
  const int bidx = idx / kBucketSize;
...
template <typename Strategy, typename OeTraits>
void MarketOrderBook<Strategy, OeTraits>::trade_order(
...
template <typename Strategy, typename OeTraits>
void MarketOrderBook<Strategy, OeTraits>::delete_order(
    const MarketData* market_update, const int idx) {
  if (market_update->side == Side::kBuy) {
...
template <typename Strategy, typename OeTraits>
void MarketOrderBook<Strategy, OeTraits>::add_order(const MarketData* market_update,
...
template <typename Strategy, typename OeTraits>
void MarketOrderBook<Strategy, OeTraits>::on_trade_update(MarketData*) {}

template <typename Strategy, typename OeTraits>
std::string MarketOrderBook<Strategy, OeTraits>::print_active_levels(
    bool is_bid) const {
  std::ostringstream stream;
...
template <typename Strategy, typename OeTraits>
int MarketOrderBook<Strategy, OeTraits>::next_active_bid(
...
template <typename Strategy, typename OeTraits>
int MarketOrderBook<Strategy, OeTraits>::next_active_ask(
    const int start_idx) const noexcept {
...
template <typename Strategy, typename OeTraits>
std::vector<int> MarketOrderBook<Strategy, OeTraits>::peek_levels(const bool is_bid,
...
template <typename Strategy, typename OeTraits>
int MarketOrderBook<Strategy, OeTraits>::find_in_bucket(const Bucket* bucket,
...
template <typename Strategy, typename OeTraits>
int MarketOrderBook<Strategy, OeTraits>::peek_levels_with_qty(bool is_bid, int level,
...
template <typename Strategy, typename OeTraits>
int MarketOrderBook<Strategy, OeTraits>::peek_qty(bool is_bid, int level,
