...
trading::OrderCancelReject* FixOrderEntryApp::create_order_cancel_reject_message(
...
FixOrderEntryApp::WireMessage FixOrderEntryApp::decode(const std::string& message) {
