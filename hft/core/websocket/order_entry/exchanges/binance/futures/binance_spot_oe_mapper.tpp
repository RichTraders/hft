...
inline trading::ExecutionReport* BinanceFuturesOeMapper::to_execution_report(
...
inline trading::OrderCancelReject* BinanceFuturesOeMapper::to_cancel_reject(
...
inline trading::OrderMassCancelReport* BinanceFuturesOeMapper::to_mass_cancel_report(
...
inline trading::OrderReject BinanceFuturesOeMapper::to_reject(const WireReject& msg) const {
...
inline trading::ExecutionReport* BinanceFuturesOeMapper::allocate_execution_report() const {
  return response_manager_->execution_report_allocate();
}

inline trading::OrderCancelReject* BinanceFuturesOeMapper::allocate_cancel_reject() const {
  return response_manager_->order_cancel_reject_allocate();
}

inline trading::OrderMassCancelReport* BinanceFuturesOeMapper::allocate_mass_cancel_report()
    const {
