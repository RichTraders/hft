...
// DepthSnapshotStreamEvent message (template ID 10002)
// Maps to sbe.xml message name="DepthSnapshotStreamEvent"
// Provides full orderbook snapshot at a specific depth level
